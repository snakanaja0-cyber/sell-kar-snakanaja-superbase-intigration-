...
const getBrandName = (brandId: string): string => {
    ...
    // Removed the extraneous and incomplete deviceData re-declaration here
    return brandNames[brandId] || brandId;
};

// Define type for deviceData keys for safer access (optional but good practice)
type DeviceTypeKey = keyof typeof deviceData;
type BrandIdKey<T extends DeviceTypeKey> = keyof typeof deviceData[T];
